...
def process_files(path1, prefix_file1, path2, prefix_file2, output_prefix, variables, start_year, end_year):
    ...
    for year in range(start_year, end_year + 1):
        ...
        for month in range(1, 13):  # Months from 1 to 12
            ...
            cruncep.attrs["history"] = (
                f"File created by nanr@ucar.edu using mk_CLMCRUNCEP_TRENDY_forcing.v2.py on {today}. "
...
def main():
    ...
    prefix_file1 = "clmforc.TRENDY.c2020.0.5x0.5.TPQWL.YYYY.nc"
    path2 = "/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/datm7/TPHWL6Hrly/"
    prefix_file2 = "clmforc.cruncep.V8.c2017.0.5d.TPQWL.YYYY-MM.nc"
