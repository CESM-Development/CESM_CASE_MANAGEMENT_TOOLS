...
subroutine diag_init()
  ...
  ! Declare the history fields for which this module contains outfld calls.
   ...
   call addfld ('VZ      ','m3/s3   ',pver, 'A','Meridional transport of geopotential energy',phys_decomp)
   ...
   ! olson
   call addfld ('OMEGA1000','Pa/s   ',1,    'A','Vertical velocity at 1000 mbar pressure surface',phys_decomp)
   call addfld ('OMEGA925 ','Pa/s   ',1,    'A','Vertical velocity at  925 mbar pressure surface',phys_decomp)
   call addfld ('OMEGA700 ','Pa/s   ',1,    'A','Vertical velocity at  700 mbar pressure surface',phys_decomp)
   call addfld ('OMEGA300 ','Pa/s   ',1,    'A','Vertical velocity at  300 mbar pressure surface',phys_decomp)
   call addfld ('OMEGA250 ','Pa/s   ',1,    'A','Vertical velocity at  250 mbar pressure surface',phys_decomp)
   call addfld ('OMEGA100 ','Pa/s   ',1,    'A','Vertical velocity at  100 mbar pressure surface',phys_decomp)
   call addfld ('OMEGA050 ','Pa/s   ',1,    'A','Vertical velocity at   50 mbar pressure surface',phys_decomp)
   ...
   ! olson
   call addfld ('T250    ','K       ',1,    'A','Temperature at 250 mbar pressure surface',phys_decomp)
   ...
   call addfld ('Q250    ','kg/kg   ',1,    'A','Specific Humidity at 250 mbar pressure surface',phys_decomp)
   ...
   ! olson
   call addfld ('U1000   ','m/s     ',1,    'A','Zonal wind at 1000 mbar pressure surface',phys_decomp)
   ...
   call addfld ('V1000   ','m/s     ',1,    'A','Meridional wind at 1000 mbar pressure surface',phys_decomp)
   ...
   call addfld ('VT1000  ','K m/s   ',1,    'A','VT at 1000 mbar pressure surface',phys_decomp)
   call addfld ('VT925   ','K m/s   ',1,    'A','VT at  925 mbar pressure surface',phys_decomp)
   call addfld ('VT850   ','K m/s   ',1,    'A','VT at  850 mbar pressure surface',phys_decomp)
   call addfld ('VT700   ','K m/s   ',1,    'A','VT at  700 mbar pressure surface',phys_decomp)
   call addfld ('VT500   ','K m/s   ',1,    'A','VT at  500 mbar pressure surface',phys_decomp)
   call addfld ('VT300   ','K m/s   ',1,    'A','VT at  300 mbar pressure surface',phys_decomp)
   call addfld ('VT250   ','K m/s   ',1,    'A','VT at  250 mbar pressure surface',phys_decomp)
   call addfld ('VT200   ','K m/s   ',1,    'A','VT at  200 mbar pressure surface',phys_decomp)
   call addfld ('VT100   ','K m/s   ',1,    'A','VT at  100 mbar pressure surface',phys_decomp)
   call addfld ('VT050   ','K m/s   ',1,    'A','VT at   50 mbar pressure surface',phys_decomp)
   call addfld ('VQ1000  ','m/skg/kg',1,    'A','VQ at 1000 mbar pressure surface',phys_decomp)
   call addfld ('VQ925   ','m/skg/kg',1,    'A','VQ at  925 mbar pressure surface',phys_decomp)
   call addfld ('VQ850   ','m/skg/kg',1,    'A','VQ at  850 mbar pressure surface',phys_decomp)
   call addfld ('VQ700   ','m/skg/kg',1,    'A','VQ at  700 mbar pressure surface',phys_decomp)
   call addfld ('VQ500   ','m/skg/kg',1,    'A','VQ at  500 mbar pressure surface',phys_decomp)
   call addfld ('VQ300   ','m/skg/kg',1,    'A','VQ at  300 mbar pressure surface',phys_decomp)
   call addfld ('VQ250   ','m/skg/kg',1,    'A','VQ at  250 mbar pressure surface',phys_decomp)
   call addfld ('VQ200   ','m/skg/kg',1,    'A','VQ at  200 mbar pressure surface',phys_decomp)
   call addfld ('VQ100   ','m/skg/kg',1,    'A','VQ at  100 mbar pressure surface',phys_decomp)
   call addfld ('VQ050   ','m/skg/kg',1,    'A','VQ at   50 mbar pressure surface',phys_decomp)
   call addfld ('VZ1000  ','m3/s3   ',1,    'A','VZ at 1000 mbar pressure surface',phys_decomp)
   call addfld ('VZ925   ','m3/s3   ',1,    'A','VZ at  925 mbar pressure surface',phys_decomp)
   call addfld ('VZ850   ','m3/s3   ',1,    'A','VZ at  850 mbar pressure surface',phys_decomp)
   call addfld ('VZ700   ','m3/s3   ',1,    'A','VZ at  700 mbar pressure surface',phys_decomp)
   call addfld ('VZ500   ','m3/s3   ',1,    'A','VZ at  500 mbar pressure surface',phys_decomp)
   call addfld ('VZ300   ','m3/s3   ',1,    'A','VZ at  300 mbar pressure surface',phys_decomp)
   call addfld ('VZ250   ','m3/s3   ',1,    'A','VZ at  250 mbar pressure surface',phys_decomp)
   call addfld ('VZ200   ','m3/s3   ',1,    'A','VZ at  200 mbar pressure surface',phys_decomp)
   call addfld ('VZ100   ','m3/s3   ',1,    'A','VZ at  100 mbar pressure surface',phys_decomp)
   call addfld ('VZ050   ','m3/s3   ',1,    'A','VZ at   50 mbar pressure surface',phys_decomp)
...
!-----------------------------------------------------------------------
    ...
    use interpolate_data,   only: vertinterp,vertinterpZT
...
!
    ...
    real(r8) ftem4(pcols,pver) ! Temporary workspace for outfld variables
    real(r8) ftem5(pcols,pver) ! Temporary workspace for outfld variables
    ...
    real(r8) p_surf_v (pcols)    ! data interpolated to a pressure surface        
    real(r8) p_surf_z (pcols)    ! data interpolated to a pressure surface        
...
! -- olson
!           
! Output Z3, T, Q, V, VT, VQ, VZ on pressure surfaces
!
! 1000 hPa
!
    if (hist_fld_active('V1000'  ) .or. & 
        hist_fld_active('VT1000' ) .or. & 
        hist_fld_active('VQ1000' ) .or. & 
        hist_fld_active('VZ1000' )) then
       call vertinterp(ncol, pcols, pver, state%pmid, 100000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT1000' ) .or. & 
        hist_fld_active('T1000'  )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid, 100000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ1000' ) .or. & 
        hist_fld_active('Q1000'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid, 100000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ1000' ) .or. &
        hist_fld_active('Z1000'  )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid, 100000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V1000'  )) then
       call outfld('V1000     ', p_surf_v, pcols, lchnk  )
    end if
    ...
    if (hist_fld_active('Z1000'  )) then
       call outfld('Z1000     ', p_surf_z, pcols, lchnk  )
    end if
    if (hist_fld_active('VT1000' )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT1000    ', p_surf, pcols, lchnk    )
    end if
    if (hist_fld_active('VQ1000' )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ1000    ', p_surf, pcols, lchnk    )
    end if
    if (hist_fld_active('VZ1000' )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ1000    ', p_surf, pcols, lchnk    )
    end if
!
! 925 hPa
!
    if (hist_fld_active('V925'   ) .or. & 
        hist_fld_active('VT925'  ) .or. & 
        hist_fld_active('VQ925'  ) .or. & 
        hist_fld_active('VZ925'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  92500._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT925'  ) .or. & 
        hist_fld_active('T925'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  92500._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ925'  ) .or. & 
        hist_fld_active('Q925'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  92500._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ925'  ) .or. &
        hist_fld_active('Z925'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  92500._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V925'   )) then
       call outfld('V925     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T925'   )) then
       call outfld('T925     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q925'   )) then
       call outfld('Q925     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z925'   )) then
       call outfld('Z925     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT925'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT925    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ925'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ925    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ925'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ925    ', p_surf, pcols, lchnk     )
    end if
!
! 850 hPa
!
    if (hist_fld_active('V850'   ) .or. & 
        hist_fld_active('VT850'  ) .or. & 
        hist_fld_active('VQ850'  ) .or. & 
        hist_fld_active('VZ850'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  85000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT850'  ) .or. & 
        hist_fld_active('T850'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  85000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ850'  ) .or. & 
        hist_fld_active('Q850'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  85000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ850'  ) .or. &
        hist_fld_active('Z850'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  85000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V850'   )) then
       call outfld('V850     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T850'   )) then
       call outfld('T850     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q850'   )) then
       call outfld('Q850     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z850'   )) then
       call outfld('Z850     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT850'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT850    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ850'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ850    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ850'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ850    ', p_surf, pcols, lchnk     )
    end if
!
! 700 hPa
!
    if (hist_fld_active('V700'   ) .or. & 
        hist_fld_active('VT700'  ) .or. & 
        hist_fld_active('VQ700'  ) .or. & 
        hist_fld_active('VZ700'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  70000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT700'  ) .or. & 
        hist_fld_active('T700'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  70000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ700'  ) .or. & 
        hist_fld_active('Q700'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  70000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ700'  ) .or. &
        hist_fld_active('Z700'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  70000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V700'   )) then
       call outfld('V700     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T700'   )) then
       call outfld('T700     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q700'   )) then
       call outfld('Q700     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z700'   )) then
       call outfld('Z700     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT700'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT700    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ700'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ700    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ700'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ700    ', p_surf, pcols, lchnk     )
    end if
!
! 500 hPa
!
    if (hist_fld_active('V500'   ) .or. & 
        hist_fld_active('VT500'  ) .or. & 
        hist_fld_active('VQ500'  ) .or. & 
        hist_fld_active('VZ500'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  50000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT500'  ) .or. & 
        hist_fld_active('T500'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  50000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ500'  ) .or. & 
        hist_fld_active('Q500'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  50000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ500'  ) .or. &
        hist_fld_active('Z500'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  50000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V500'   )) then
       call outfld('V500     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T500'   )) then
       call outfld('T500     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q500'   )) then
       call outfld('Q500     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z500'   )) then
       call outfld('Z500     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT500'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT500    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ500'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ500    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ500'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ500    ', p_surf, pcols, lchnk     )
    end if
!
! 300 hPa
!
    if (hist_fld_active('V300'   ) .or. & 
        hist_fld_active('VT300'  ) .or. & 
        hist_fld_active('VQ300'  ) .or. & 
        hist_fld_active('VZ300'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  30000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT300'  ) .or. & 
        hist_fld_active('T300'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  30000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ300'  ) .or. & 
        hist_fld_active('Q300'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  30000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ300'  ) .or. &
        hist_fld_active('Z300'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  30000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V300'   )) then
       call outfld('V300     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T300'   )) then
       call outfld('T300     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q300'   )) then
       call outfld('Q300     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z300'   )) then
       call outfld('Z300     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT300'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT300    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ300'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ300    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ300'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ300    ', p_surf, pcols, lchnk     )
    end if
!
! 250 hPa
!
    if (hist_fld_active('V250'   ) .or. & 
        hist_fld_active('VT250'  ) .or. & 
        hist_fld_active('VQ250'  ) .or. & 
        hist_fld_active('VZ250'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  25000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT250'  ) .or. & 
        hist_fld_active('T250'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  25000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ250'  ) .or. & 
        hist_fld_active('Q250'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  25000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ250'  ) .or. &
        hist_fld_active('Z250'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  25000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V250'   )) then
       call outfld('V250     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T250'   )) then
       call outfld('T250     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q250'   )) then
       call outfld('Q250     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z250'   )) then
       call outfld('Z250     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT250'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT250    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ250'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ250    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ250'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ250    ', p_surf, pcols, lchnk     )
    end if
!
! 200 hPa
!
    if (hist_fld_active('V200'   ) .or. & 
        hist_fld_active('VT200'  ) .or. & 
        hist_fld_active('VQ200'  ) .or. & 
        hist_fld_active('VZ200'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  20000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT200'  ) .or. & 
        hist_fld_active('T200'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  20000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ200'  ) .or. & 
        hist_fld_active('Q200'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  20000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ200'  ) .or. &
        hist_fld_active('Z200'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  20000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V200'   )) then
       call outfld('V200     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T200'   )) then
       call outfld('T200     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q200'   )) then
       call outfld('Q200     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z200'   )) then
       call outfld('Z200     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT200'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT200    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ200'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ200    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ200'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ200    ', p_surf, pcols, lchnk     )
    end if
!
! 100 hPa
!
    if (hist_fld_active('V100'   ) .or. & 
        hist_fld_active('VT100'  ) .or. & 
        hist_fld_active('VQ100'  ) .or. & 
        hist_fld_active('VZ100'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  10000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT100'  ) .or. & 
        hist_fld_active('T100'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  10000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ100'  ) .or. & 
        hist_fld_active('Q100'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,  10000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ100'  ) .or. &
        hist_fld_active('Z100'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,  10000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V100'   )) then
       call outfld('V100     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T100'   )) then
       call outfld('T100     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q100'   )) then
       call outfld('Q100     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z100'   )) then
       call outfld('Z100     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT100'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT100    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ100'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ100    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ100'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ100    ', p_surf, pcols, lchnk     )
    end if
!
! 50 hPa
!
    if (hist_fld_active('V050'   ) .or. & 
        hist_fld_active('VT050'  ) .or. & 
        hist_fld_active('VQ050'  ) .or. & 
        hist_fld_active('VZ050'  )) then
       call vertinterp(ncol, pcols, pver, state%pmid,   5000._r8, state%v       , p_surf_v)
    end if
    if (hist_fld_active('VT050'  ) .or. & 
        hist_fld_active('T050'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,   5000._r8, state%t       , p_surf_t1, &
          extrapolate='T', ln_interp=.false., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('VQ050'  ) .or. & 
        hist_fld_active('Q050'   )) then
       call vertinterp(ncol, pcols, pver, state%pmid,   5000._r8, state%q(1,1,1), p_surf_q1)
    end if
    if (hist_fld_active('VZ050'  ) .or. &
        hist_fld_active('Z050'   )) then
       call vertinterpZT(ncol, pcols, pver, state%pmid,   5000._r8, z3            , p_surf_z, &
          extrapolate='Z', ln_interp=.true., ps=state%ps, phis=state%phis, tbot=state%t(:,pver))
    end if
    if (hist_fld_active('V050'   )) then
       call outfld('V050     ', p_surf_v, pcols, lchnk   )
    end if
    if (hist_fld_active('T050'   )) then
       call outfld('T050     ', p_surf_t1, pcols, lchnk  )
    end if
    if (hist_fld_active('Q050'   )) then
       call outfld('Q050     ', p_surf_q1, pcols, lchnk  )
    end if
    if (hist_fld_active('Z050'   )) then
       call outfld('Z050     ', p_surf_z, pcols, lchnk   )
    end if
    if (hist_fld_active('VT050'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_t1(:ncol   )
       call outfld('VT050    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VQ050'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_q1(:ncol   )
       call outfld('VQ050    ', p_surf, pcols, lchnk     )
    end if
    if (hist_fld_active('VZ050'  )) then
       p_surf(:ncol) = p_surf_v(:ncol)*p_surf_z(:ncol    )*gravit
       call outfld('VZ050    ', p_surf, pcols, lchnk     )
    end if
...
!
! Output u fields on pressure surfaces
!
...
!! Boundary layer atmospheric stability, temperature, water vapor diagnostics
    ...
    if (hist_fld_active('T9251000')   .or. & 
