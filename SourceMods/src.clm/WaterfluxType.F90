...
contains
  ...
  subroutine InitHistory(this, bounds)
    ...
    call hist_addfld1d (fname='QSNOEVAP_ICE', units='mm/s',  &
         avgflag='A', long_name='evaporation from snow (ice landunits only)', &
         ptr_patch=this%qflx_ev_snow_patch, c2l_scale_type='urbanf', l2g_scale_type='ice')
