...
!-----------------------------------------------------------------------
   ...
   integer (int_kind) :: &
      ...
      tavg_EVAP_F_2,     &! tavg id for 5-day mean evaporation flux
      tavg_PREC_F,       &! tavg id for precipitation flux (rain + snow)
      tavg_PREC_F_2,     &! tavg id for 5-day mean precipitation flux (rain + snow)
      tavg_SNOW_F,       &! tavg id for snow          flux
      tavg_SNOW_F_2,     &! tavg id for 5-day mean snow          flux
      tavg_MELT_F,       &! tavg id for melt          flux
      tavg_MELT_F_2,     &! tavg id for 5-day mean melt          flux
      tavg_ROFF_F,       &! tavg id for river runoff  flux
      tavg_ROFF_F_2,     &! tavg id for 5-day mean river runoff  flux
      tavg_IOFF_F,       &! tavg id for ice   runoff  flux due to land-model snow capping
      tavg_IOFF_F_2,     &! tavg id for 5-day mean ice   runoff  flux due to land-model snow capping
      tavg_SALT_F,       &! tavg id for salt          flux
      tavg_SALT_F_2,     &! tavg id for 5-day mean salt          flux
      tavg_SENH_F,       &! tavg id for sensible heat flux
      tavg_SENH_F_2,     &! tavg id for 5-day mean sensible heat flux
      tavg_LWUP_F,       &! tavg id for longwave heat flux up
      tavg_LWUP_F_2,     &! tavg id for 5-day mean longwave heat flux up
      tavg_LWDN_F,       &! tavg id for longwave heat flux dn
      tavg_LWDN_F_2,     &! tavg id for 5-day mean longwave heat flux dn
      tavg_MELTH_F,      &! tavg id for melt     heat flux
      tavg_MELTH_F_2,    &! tavg id for 5-day mean melt     heat flux
