...
!-----------------------------------------------------------------------
   ...
   do n = 1,nt
      ...
      call define_tavg_field(tavg_HDIFE_TRACER(n,1),                      &
                             'HDIFE_' /&
                                       &/ trim(tracer_d(n)%short_name),3, &
      ...
      call define_tavg_field(tavg_HDIFE_TRACER(n,2),                      &
                             'HDIFE_' /&
                                       &/ trim(tracer_d(n)%short_name)   /&
                                       &/'_2',3, &
                                long_name=trim(tracer_d(n)%short_name)   /&
      ...
      call define_tavg_field(tavg_HDIFN_TRACER(n,1),                        &
                             'HDIFN_' /&
                                       &/ trim(tracer_d(n)%short_name),3, &
                                long_name=trim(tracer_d(n)%short_name)   /&
      ...
      call define_tavg_field(tavg_HDIFN_TRACER(n,2),                        &
                             'HDIFN_' /&
                                       &/ trim(tracer_d(n)%short_name)   /&
                                       &/'_2',3, &
                                long_name=trim(tracer_d(n)%short_name)   /&
      ...
      call define_tavg_field(tavg_HDIFB_TRACER(n,1),                        &
                             'HDIFB_' /&
                                       &/ trim(tracer_d(n)%short_name),3, &
                                long_name=trim(tracer_d(n)%short_name)   /&
      ...
      call define_tavg_field(tavg_HDIFB_TRACER(n,2),                        &
                             'HDIFB_' /&
                                       &/ trim(tracer_d(n)%short_name)   /&
                                       &/'_2',3, &
                                long_name=trim(tracer_d(n)%short_name)   /&
