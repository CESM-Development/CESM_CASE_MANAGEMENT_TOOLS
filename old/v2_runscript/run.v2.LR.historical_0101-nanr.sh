...
readonly CASE_NAME="v2.LR.historical_0101-test"
readonly CASE_GROUP="v2.LR"

# Code and compilation
readonly CHECKOUT="20211216"
readonly BRANCH="d02413bdabd06a5b85d090cf125fa21787cd41dd" # master as of 2021-12-16
readonly CHERRY=(  )
...
readonly RUN_REFDIR="/global/cscratch1/sd/golaz/E3SMv2/v2.LR.historical_0101-test/init"
...
cat << EOF >> user_nl_eam
 ...
 ! monthly (h0) A
 fincl1 = 'extinct_sw_inp','extinct_lw_bnd7','extinct_lw_inp','CLD_CAL', 'TREFMNAV', 'TREFMXAV','IEFLX','ZMDT','ZMDQ','STEND_CLUBB', 'RVMTEND_CLUBB', 'MPDT', 'MPDQ', 'DCQ', 'DTCOND'
 ! daily (h1) A
