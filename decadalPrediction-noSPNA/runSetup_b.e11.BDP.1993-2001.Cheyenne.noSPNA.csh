...
#setenv HOMEDIR /glade/u/home/nanr/ccp/decadalPrediction/decadalPrediction-noSPNA/
setenv HOMEDIR /glade/work/nanr/cesm_tags/CASE_tools/cesm1-DP/decadalPrediction-noSPNA/
setenv CESMROOT /glade/work/nanr/cesm_tags/cesm1_1_2_LENS_n21
setenv MACH cheyenne
setenv COMPSET B20TRLENS
setenv RESLN f09_g16
setenv CESMINPUT /glade/p/cesmdata/cseg/inputdata
setenv DPINPUT /glade/scratch/$USER/DP/inputdata/DP

# ===========================================
# REMEMBER:  1993-11 start date for year 1994
# Script will adjust by subtracting 1 year (yearm1)
# ===========================================
set syr = 1994
set eyr = 2001
set eyr = 1994
...
set REFCASE    = b.e11.BDP_IC_noSPNA.f09_g16.${yearm1}-11.01	
set SHORTCASE  = b.e11.BDP_noSPNAT.f09_g16.${yearm1}-11
if ($mbr < 10) then
	set CASE = b.e11.BDP_noSPNAT.f09_g16.${yearm1}-11.00${mbr}
else
	set CASE = b.e11.BDP_noSPNAT.f09_g16.${yearm1}-11.0${mbr}
endif
echo 'Year   = ' $year
echo 'Member = ' $mbr
echo 'Case   = ' $CASE

setenv SHORTCASEROOT /glade/p/cesmdata/cseg/runs/cesm1_1/decadalPrediction/
setenv CASEROOT /glade/p/cesmdata/cseg/runs/cesm1_1/decadalPrediction/$CASE
setenv INITDIR  /glade/scratch/nanr/DP
setenv RESTDIR /$INITDIR/ccsm4_init/$REFCASE/$yearm1-11-01/
setenv DPDIR   /glade/scratch/$USER/DP/rundir/
...
./xmlchange -file env_run.xml   -id DOUT_S_ROOT     -val '/glade/scratch/nanr/DP/archive/$CASE/'
./xmlchange -file env_build.xml -id EXEROOT         -val '/glade/scratch/nanr/DP/rundir/$CASE/bld'
./xmlchange -file env_run.xml   -id RUNDIR          -val '/glade/scratch/nanr/DP/rundir/$CASE/run'

./cesm_setup
 # SteveY+KeithL SourceMods
 cp $HOMEDIR/SourceMods/src.pop2/* $CASEROOT/SourceMods/src.pop2/
 # ColinZ SourceMods
 cp $HOMEDIR/SourceMods/src.cam/* $CASEROOT/SourceMods/src.cam/
...
! Six-hourly output is turned on for 1990-2005 only
histfreq='m','d','x','x','x'
!histfreq='m','d','h','x','x'
...
cat tmp2.run | sed 's/###PBS -A/#PBS -A CESM0015/;' > $CASE.run
rm   tmp.run
rm  tmp2.run
...
fincl3='PSL:I','T400:I','U850:I','UBOT:I','V850:I','VBOT:I','Z300:I','Z500:I'
...
! forcing for 1955 - ~2020 created by nanr
 ...
 prescribed_volcaero_datapath   = '$DPINPUT/atm/cam/volc'
 prescribed_volcaero_file       = 'CCSM4_volcanic_1950115-20300115_prototype1_c150715.nc'
