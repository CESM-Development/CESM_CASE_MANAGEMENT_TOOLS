...
basecasename = "PPE_220_ensemble_4xCO2"
...
# Will be the same in every case
ref_case_get = True
ref_case_name = "PPE_220_ensemble_1850.220"
ref_date = "1306-01-01"
ref_case_path = "cesm2_init"
#ref_case_path = "/glade/scratch/nanr/archive/PPE_220_ensemble_1850.220/rest/"
...
def build_base_case(baseroot, basecasename, res, compset, overwrite):
    ...
    with Case(caseroot, read_only=False) as case:
        if not os.path.isdir(caseroot):
            ...
            case.set_value("RUN_REFDATE",ref_date)
            case.set_value("RUN_STARTDATE","1850-01-01")
