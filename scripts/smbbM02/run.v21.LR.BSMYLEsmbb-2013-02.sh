...
if [ "${run}" != "production" ]; then
  ...
  # 2013-05 through 2014-12 = 20 months; HIST portion has 2015 in it; 
  # 2013-02 through 2014-12 = 23 months; HIST portion has 2015 in it; 
  # then switch to SSP370 (which has 2014 in as well)
  STOP_N="23" # How often to stop the model, should be a multiple of REST_N
  REST_N="23" # How often to write a restart file
