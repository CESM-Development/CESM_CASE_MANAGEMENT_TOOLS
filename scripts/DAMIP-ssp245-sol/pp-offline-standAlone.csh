...
setenv CESM2_TOOLS_ROOT /glade/work/nanr/cesm_tags/CASE_tools/cesm2-cmip6/
...
if ($mbr < 10) then
        set CASE = b.e21.B1850cmip6.f09_g17.DAMIP-ssp245-sol.00${mbr}
else
        set CASE = b.e21.B1850cmip6.f09_g17.DAMIP-ssp245-sol.0${mbr}
endif
...
cp $CESM2_TOOLS_ROOT/scripts/DAMIP-ssp245-sol/timeseries $CASEROOT/$CASE/postprocess
