...
foreach  case ( PMay0_lev1-2_1mon_ext )
foreach member (  `seq -w 92 99`  )
#foreach member ( 100 )
...
./xmlchange -file env_run.xml -id RUN_STARTDATE -val $icyr'-06-01'
./xmlchange -file env_run.xml -id RUN_REFDATE -val $icyr'-06-01' 
./xmlchange -file env_run.xml -id RUN_REFCASE -val 'PMay0_lev1-2_1mon-'$member 
./xmlchange -file env_run.xml -id STOP_OPTION  -val  'nmonths'
./xmlchange -file env_run.xml -id STOP_N -val '9'
./xmlchange -file env_run.xml -id REST_N -val '9'
...
cp /glade2/scratch2/hteng/archive/PMay0_lev1-2_1mon-{$member}/rest/*06-01*/* .
...
# copy namelist
cp {$myhome}/namelist/user_nl_clm_zero_yellowstone   ${caseroot}/user_nl_clm 
...
cat $casename.run |  sed 's/01:50:00/01:00:00/g' >& test.run
