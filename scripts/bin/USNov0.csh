...
\rm -fr /glade/u/home/hteng/soil/{$casename}
\rm -fr /glade2/scratch2/hteng/{$casename}
...
./xmlchange -file env_run.xml -id RUN_STARTDATE -val $icyr'-11-01'
./xmlchange -file env_run.xml -id RUN_REFDATE -val $icyr'-11-01' 
...
cp /glade2/scratch2/hteng/archive/CAM5.ctrl-{$member}/rest/*11-01-00000/* .
mkdir /glade/scratch/hteng/$casename/bld
cd /glade/scratch/hteng/$casename/bld 
ln  -s /glade/scratch/hteng/USNov0-100/bld/cesm.exe  .

cd $caseroot

# copy namelist
cp {$myhome}/soil/namelist/user_nl_clm_US0  ${caseroot}/user_nl_clm 
