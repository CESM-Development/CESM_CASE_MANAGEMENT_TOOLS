...
cd /glade/p/work/nanr/cesm_tags/cesm1_1_2_LENS_n16/scripts 
...
cp /glade/p/cgd/ccr/people/hteng/CAM5.ctrl/jan/CAM5.ctrl-{$member}.tar .
...
#ln  -s /glade/scratch/hteng/CAM5.ctrl-01/bld/cesm.exe  .

cd $caseroot
# copy namelist
#cp {$myhome}/soil/namelist/user_nl_clm_zero ${caseroot}/user_nl_clm 
...
./*.build
cat $casename.run |  sed 's/01:50:00/00:40:00/g' >& test.run
