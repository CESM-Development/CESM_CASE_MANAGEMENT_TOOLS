...
foreach  case ( WPMay0 )
#foreach member (  `seq -w 11 99`  )
#foreach member ( 100 )
#foreach member (  17  27  36    49   52   61) 
#foreach member ( 64 66 67 68 69 71 73 76 80 83 96 )  
foreach member ( 66  83   ) 
...
cp /glade2/scratch2/hteng/archive/CAM5.ctrl-{$member}/rest/*05-01-00000/* .
mkdir /glade/scratch/hteng/$casename/bld
cd /glade/scratch/hteng/$casename/bld 
#ln  -s /glade/scratch/hteng/WPMay0-61/bld/cesm.exe  .
