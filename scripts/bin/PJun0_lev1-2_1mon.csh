...
foreach  case ( PJun0_lev1-2_1mon )
...
cp /glade/p/cgd/ccr/people/hteng/CAM5.ctrl/jun/CAM5.ctrl-{$member}.tar .
tar xvf *.tar
...
# copy namelist
cp {$myhome}/namelist/user_nl_clm_P0_lev1-2  ${caseroot}/user_nl_clm 
...
cat $casename.run |  sed 's/01:50:00/00:15:00/g' >& test.run
