...
foreach  case ( ca40ice )
#foreach member (  `seq -w 01 99`  )
foreach member ( `seq -w 91 99 `  ) 
#foreach member ( 100 )
...
ln  -s /glade/scratch/hteng/ca0-100/bld/cesm.exe  .

cd $caseroot

# copy namelist
cp {$myhome}/soil/namelist/user_nl_clm_ca40ice ${caseroot}/user_nl_clm 
