...
foreach  case ( PMay0_lev1 )
#foreach member (  `seq -w 01 99`  )
#foreach member ( 100 )
foreach member ( 56 59 63 66 67 68 69 71 72 75 77 81 86 88 90 91 92 93 95 96 98 )
...
# copy namelist
cp {$myhome}/namelist/user_nl_clm_P0_lev1  ${caseroot}/user_nl_clm 
