...
cp {$myhome}/soil/sourcemods/read_in_soil_moisture.F90.liqonly {$caseroot}/SourceMods/src.clm/read_in_soil_moisture.F90
...
ln  -s /glade/scratch/hteng/CA0liq-01/bld/cesm.exe  .

cd $caseroot

# copy namelist
cp {$myhome}/soil/namelist/user_nl_clm_ca0  ${caseroot}/user_nl_clm 
