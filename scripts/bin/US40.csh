...
foreach member ( 45 )
#foreach member ( ` seq -w 17 45 ` )
\rm -fr /glade/u/home/hteng/soil/$case-$member
\rm -fr /glade/scratch/hteng/$case-$member
...
ln  -s /glade/scratch/hteng/US40-100/bld/cesm.exe  .

cd $caseroot

# copy namelist
cp {$myhome}/soil/namelist/user_nl_clm_US40 ${caseroot}/user_nl_clm 
