...
#\rm -fr $caseroot
\rm -fr /glade/scratch/hteng/{$casename}
...
ln  -s /glade/scratch/hteng/WPNov0-100/bld/cesm.exe  .

cd $caseroot

# copy namelist
cp {$myhome}/soil/namelist/user_nl_clm_WP0  ${caseroot}/user_nl_clm 
