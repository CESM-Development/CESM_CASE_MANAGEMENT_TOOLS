...
foreach  case ( PJul0_lev1-2_1mon_ext )
...
./xmlchange -file env_run.xml -id RUN_STARTDATE -val $icyr'-08-01'
./xmlchange -file env_run.xml -id RUN_REFDATE -val $icyr'-08-01' 
./xmlchange -file env_run.xml -id RUN_REFCASE -val 'PJul0_lev1-2_1mon-'$member 
...
cp /glade2/scratch2/hteng/archive/PJul0_lev1-2_1mon-{$member}/rest/*08-01*/* .
