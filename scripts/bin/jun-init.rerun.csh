...
cp /glade/scratch/hteng/archive/CAM5.ctrl-{$member}/rest/*{$rtfile}*/* .

mkdir /glade/scratch/hteng/$casename/bld
cd /glade/scratch/hteng/$casename/bld 
ln  -s /glade/scratch/hteng/CAM5.ctrl-35/bld/cesm.exe  .
...
cat $casename.run |  sed 's/01:50:00/00:20:00/g' >& test.run
