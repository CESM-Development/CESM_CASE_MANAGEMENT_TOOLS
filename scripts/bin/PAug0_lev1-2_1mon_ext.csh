...
foreach  case ( PAug0_lev1-2_1mon_ext )
...
./xmlchange -file env_run.xml -id RUN_STARTDATE -val $icyr'-09-01'
./xmlchange -file env_run.xml -id RUN_REFDATE -val $icyr'-09-01' 
./xmlchange -file env_run.xml -id RUN_REFCASE -val 'PAug0_lev1-2_1mon-'$member 
...
cp /glade2/scratch2/hteng/archive/PAug0_lev1-2_1mon-{$member}/rest/*09-01*/* .
