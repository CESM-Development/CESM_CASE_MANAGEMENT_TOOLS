...
#ln  -s /glade/scratch/hteng/CAM5.ctrl-100/bld/cesm.exe  .

cd $caseroot
# copy namelist
cp {$myhome}/soil/namelist/user_nl_clm_zero_yellowstone   ${caseroot}/user_nl_clm 
...
cat $casename.run |  sed 's/8:00/0:40/g' >& test.run
