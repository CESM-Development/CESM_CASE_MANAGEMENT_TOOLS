...
ln  -s /glade/scratch/hteng/soil_me-01/bld/cesm.exe  .

cd $caseroot
# copy namelist
cp {$myhome}/soil/namelist/user_nl_clm_ca60 ${caseroot}/user_nl_clm 
...
cat $casename.run |  sed 's/01:50:00/00:45:00/g' >& test.run
