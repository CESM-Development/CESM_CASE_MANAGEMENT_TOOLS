...
CASE_NAME="v2.LR.BSMYLE.${useyear}-${usemonth}.${mbr}"
if [[ ${imbr} -eq "1" ]]
then
  #MAIN_CASE_NAME="v21.LR.BSMYLE-MYTEST.${useyear}-${usemonth}.${mbr}"
  MAIN_CASE_NAME="v2.LR.BSMYLE.${useyear}-${usemonth}.${mbr}"
fi
CASE_GROUP="v2.LR"
...
MAIN_CASE_ROOT="/pscratch/sd/n/${USER}/v2.LR.SMYLE/${MAIN_CASE_NAME}"
CASE_ROOT="/pscratch/sd/n/${USER}/v2.LR.SMYLE/${MAIN_CASE_NAME}/"

# Sub-directories
#CASE_BUILD_DIR=${MAIN_CASE_ROOT}/build
CASE_BUILD_DIR=/pscratch/sd/n/nanr/v2.LR.SMYLE/exeroot/build
...
OLD_EXECUTABLE="/pscratch/sd/n/nanr/v2.LR.SMYLE/exeroot/build"
