...
CASE_NAME="v21.LR.BSMYLE_CANFIRE.${useyear}-${usemonth}.${mbr}"
CASE_GROUP="v21.LR"

if [[ ${imbr} -eq "1" ]]
then
  MAIN_CASE_NAME="v21.LR.BSMYLE_CANFIRE.${useyear}-${usemonth}.001"
fi
CASE_GROUP="v21.LR"
...
MAIN_CASE_ROOT="${SCRATCH}/v21.LR.BSMYLE_CANFIRE/${MAIN_CASE_NAME}"
CASE_ROOT="${SCRATCH}/v21.LR.BSMYLE_CANFIRE/${MAIN_CASE_NAME}/"

# Sub-directories
CASE_BUILD_DIR=/pscratch/sd/n/nanr/v21.LR.BSMYLE_CANFIRE/exeroot/build
