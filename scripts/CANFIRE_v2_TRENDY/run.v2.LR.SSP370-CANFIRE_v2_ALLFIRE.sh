...
CASE_NAME="v21.LR.BSMYLE_v2_CANFIRE_ALLFIRE.${useyear}-${usemonth}.${mbr}"
CASE_GROUP="v21.LR"

if [[ ${imbr} -eq "1" ]]
then
  MAIN_CASE_NAME="v21.LR.BSMYLE_v2_CANFIRE_ALLFIRE.${useyear}-${usemonth}.001"
fi
CASE_GROUP="v21.LR"
...
MAIN_CASE_ROOT="${SCRATCH}/v21.LR.BSMYLE_v2_CANFIRE_ALLFIRE/${MAIN_CASE_NAME}/"
CASE_ROOT="${SCRATCH}/v21.LR.BSMYLE_v2_CANFIRE_ALLFIRE/${MAIN_CASE_NAME}/"

# Sub-directories
CASE_BUILD_DIR=/pscratch/sd/n/nanr/v21.LR.BSMYLE_v2_CANFIRE_ALLFIRE/exeroot/build
...
cat << EOF >> user_nl_eam
 ...
 ext_frc_specifier = 'SO2  ->  /global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/cam/chem/emissions_ssp370_smoothed-CANFIRE/so2_elev_QFED_2020-2024_c251103_zfilled.nc',
    'bc_a4       -> /global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/cam/chem/emissions_ssp370_smoothed-CANFIRE/bc_a4_elev_QFED_2020-2024_c251103_zfilled.nc',
    'num_a1      -> /global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/cam/chem/emissions_ssp370_smoothed-CANFIRE/num_a1_elev_QFED_2020-2024_c251103_zfilled.nc',
    ...
    'num_a4      -> /global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/cam/chem/emissions_ssp370_smoothed-CANFIRE/num_a4_elev_QFED_2020-2024_c251103_zfilled.nc',
    'pom_a4      -> /global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/cam/chem/emissions_ssp370_smoothed-CANFIRE/pom_a4_elev_QFED_2020-2024_c251103_zfilled.nc',
    'so4_a1      -> /global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/cam/chem/emissions_ssp370_smoothed-CANFIRE/so4_a1_elev_QFED_2020-2024_c251103_zfilled.nc',
    ...
    'SOAG        -> /global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/atm/cam/chem/emissions_ssp370_smoothed-CANFIRE/soag_elev_QFED_2020-2024_c251103_zfilled.nc'
