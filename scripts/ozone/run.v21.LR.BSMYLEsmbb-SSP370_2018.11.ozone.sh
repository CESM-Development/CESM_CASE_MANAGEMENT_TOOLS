...
CASE_NAME="v21.LR.BSMYLE_ozone.${useyear}-${usemonth}.${mbr}"
if [[ ${imbr} -eq "1" ]]
then
  #MAIN_CASE_NAME="v21.LR.BSMYLE-MYTEST.${useyear}-${usemonth}.${mbr}"
  MAIN_CASE_NAME="v21.LR.BSMYLE_ozone.${useyear}-${usemonth}.${mbr}"
fi
CASE_GROUP="v21.LR"
...
GET_REFCASE=false
RUN_REFDIR="/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/e3sm_init/v21.LR.SMYLE_IC_ozone.${useyear}-${usemonth}.01/"
RUN_REFCASE="v21.LR.SMYLE_IC_ozone.${useyear}-${usemonth}.01"
...
MAIN_CASE_ROOT="/pscratch/sd/n/${USER}/v21.LR.BSMYLE_ozone/${MAIN_CASE_NAME}"
CASE_ROOT="/pscratch/sd/n/${USER}/v21.LR.BSMYLE_ozone/${MAIN_CASE_NAME}/"

# Sub-directories
#CASE_BUILD_DIR=${MAIN_CASE_ROOT}/build
CASE_BUILD_DIR=/pscratch/sd/n/nanr/v21.LR.BSMYLE_ozone/exeroot/build
...
case_setup() {
    ...
    eamic="v21.LR.SMYLE_IC_ozone.${useyear}-${usemonth}.01.eam.i.${useyear}-${usemonth}-01-00000.nc"
    perteamic="v21.LR.SMYLE_IC_ozone.pert.eam.i.${useyear}-${usemonth}-01-00000.nc"
    ics="/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/e3sm_init/v21.LR.SMYLE_IC_ozone.${useyear}-${usemonth}.01/"
