...
readonly CASE_NAME="v2.LR.20TR_neg0.5Sv.001"
...
echo $MODEL_START_TYPE

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=TRUE
readonly RUN_REFDIR="/pscratch/sd/n/nanr/archive/v2.LR.piControl/rest/0501-01-01-00000/"
...
readonly CODE_ROOT="${MY_PATH}/e3sm_tags/E3SMv2-hosing/"
...
case_setup() {
    ...
    #cp /global/homes/n/nanr/CESM_tools/e3sm/v2/scripts/amoc-hosing/env_mach_pes/env_mach_pes.xml .
    #cp /pscratch/sd/n/nanr/v21.LR.20TR_neg10xSv.001/case_scripts/env_mach_pes.xml .
    cp /pscratch/sd/n/nanr/v2.LR.GHG-SF/v2.LR.hist-GHG_0121/case_scripts/env_mach_pes.xml .
