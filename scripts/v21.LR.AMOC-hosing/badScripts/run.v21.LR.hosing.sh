...
readonly CASE_NAME="v21.LR.hosingRampUp.beta1.001"
...
readonly START_DATE="0108-01-01"

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=TRUE
readonly RUN_REFDIR="/global/cfs/cdirs/mp9/archive/e3smv2/v21.LR.hosingRampUp.beta1.001/rest/"
readonly RUN_REFCASE="v21.LR.hosingRampUp.beta1.001"
readonly RUN_REFDATE="0108-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'
