...
readonly CASE_NAME="v21.LR.hosingRampUp-EXTEND.001"
...
readonly START_DATE="0148-01-01"

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=TRUE
readonly RUN_REFDIR="/pscratch/sd/n/nanr/v21.LR.hosingRampUp.001/archive/rest/0148-01-01-00000/"
readonly RUN_REFCASE="v21.LR.hosingRampUp.001"
readonly RUN_REFDATE="0148-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'

# Set paths
#readonly MY_PATH="/global/cfs/cdirs/ccsm1/people/nanr"
readonly MY_PATH="/global/cfs/cdirs/mp9/"
#readonly CODE_ROOT="${MY_PATH}/e3sm_tags/E3SMv2/code/${CHECKOUT}"
#readonly CODE_ROOT="${MY_PATH}/e3sm_tags/E3SMv2.1/code/v2.1.0-beta.3-hosing"
readonly CODE_ROOT="${MY_PATH}/e3sm_tags/E3SMv2.1-hosing/v2.1.0-beta.1"
#readonly CASE_ROOT="${MY_PATH}/cases/e3smv2.1/${CASE_NAME}"
readonly CASE_ROOT="${SCRATCH}/${CASE_NAME}"

# Sub-directories
readonly CASE_BUILD_DIR=${CASE_ROOT}/bld
...
case_setup() {
    ...
    # Add Hosing SourceMods
    cp /global/homes/n/nanr/CESM_tools/e3sm/v2/scripts/amoc-hosing/SourceMods/src.mpaso/mpas_ocn_thick_surface_flux.F ./SourceMods/src.mpaso/
    cp /global/homes/n/nanr/CESM_tools/e3sm/v2/scripts/amoc-hosing/transientForcing/streams.ocean ./SourceMods/src.mpaso/
