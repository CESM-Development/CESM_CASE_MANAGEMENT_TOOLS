...
CASE_ROOT="/pscratch/sd/n/nanr/v2.LR.BMB-SF/${CASE_NAME}"
...
#OLD_EXECUTABLE=""
#OLD_EXECUTABLE="/pscratch/sd/n/nanr/v2.LR.BMB-SF/EXEROOT/build/e3sm.exe"
...
case_setup() {
    ...
    # nanr changes
    #./xmlchange EXEROOT=/pscratch/sd/n/nanr/v2.LR.BMB-SF/EXEROOT/build/
