...
RUN_REFDIR="/pscratch/sd/n/nanr/v2.LR.GHG-SF/v2.LR.hist-GHG_0161-old/archive/rest/${START_DATE}-00000"
...
RUN_REFCASE="v2.LR.hist-GHG_0161"
RUN_REFDATE="${START_DATE}"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'
...
CODE_ROOT="/global/cfs/cdirs/mp9/e3sm_tags/E3SMv2.0/E3SM/"
