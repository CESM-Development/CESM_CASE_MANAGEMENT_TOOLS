...
#setenv CASENAME b.e21.${USECOMPSET}.f09_g17.TIPMIP_AAHosing_0.5Sv.00${mbr}
setenv CASENAME b.e21.${USECOMPSET}.f09_g17.TIPMIP_AAHosing_0.1Sv.00${mbr}
...
#cp $CESM_TOOLS/user_nl_files/AntarcticHosing/0.5Sv/user_nl* $CASEROOT/
cp $CESM_TOOLS/user_nl_files/AntarcticHosing/0.1Sv/user_nl* $CASEROOT/
...
#cp /glade/work/nanr/TIPMIP/forcing/AntarcticHosingNoCompensation_65SSouth_05Sv200yr-xtime.nc /glade/derecho/scratch/nanr/$CASENAME/run/
cp /glade/work/nanr/TIPMIP/forcing/AntarcticHosingNoCompensation_65SSouth_01Sv200yr-xtime.nc /glade/derecho/scratch/nanr/$CASENAME/run/
