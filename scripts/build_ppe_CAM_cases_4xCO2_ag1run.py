...
basecasename = "PPE_250_ensemble_4xCO2"
baseroot = os.path.join("/glade/work/fasullo/cam_dev","ppe_cases",basecasename)
res = "f09_f09_mg17"
compset = "F2000climo"
...
ensemble_startval = "001" # Three digit value for the member wishing to be done - 1 based index (wish to do 20, 28, 38         128         139         175, 212         220         250         263) 
