...
cp $curdir/user_nl_files/AMIP-nudging-clim/user_nl_cam ./user_nl_cam
cp $curdir/user_nl_files/AMIP-nudging-clim/user_nl_cice .
cp $curdir/user_nl_files/AMIP-nudging-clim/user_nl_clm .
cp $curdir/user_nl_files/AMIP-nudging-clim/user_nl_cpl .
cp $curdir/user_nl_files/AMIP-nudging-clim/user_nl_mosart .
cp $curdir/user_nl_files/AMIP-nudging-clim/user_nl_ww .
