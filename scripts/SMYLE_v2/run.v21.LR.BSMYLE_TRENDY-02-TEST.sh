...
CASE_NAME="v21.LR.BSMYLE_v2_TEST.${useyear}-${usemonth}.${mbr}"
if [[ ${imbr} -eq "1" ]]
then
  #MAIN_CASE_NAME="v21.LR.BSMYLE-MYTEST.${useyear}-${usemonth}.${mbr}"
  MAIN_CASE_NAME="v21.LR.BSMYLE_v2_TEST.${useyear}-${usemonth}.${mbr}"
fi
CASE_GROUP="v21.LR"
...
if [ "${run}" != "production" ]; then
  ...
  REST_OPTION="ndays"
  REST_N="10" # How often to write a restart file
...
! (6) GHG as classic
 bndtvghg               = '/global/cfs/cdirs/e3sm/inputdata/atm/cam/ggas/GHG_CMIP-1-2-0_Annual_Global_0000-2014_c20181106.nc'
