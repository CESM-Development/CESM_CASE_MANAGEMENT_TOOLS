...
#echo $CASE 
    ...
    #cp /pscratch/sd/n/nanr/v21.LR.BSMYLE_v2/v21.LR.BSMYLE_v2.2013-02.001/case_scripts.002/env_mach_specific.xml .
    #./xmlchange STOP_N=14
    #./xmlchange REST_N=14
    #./xmlchange EXEROOT=/pscratch/sd/n/nanr/v21.LR.BSMYLE_v2/exeroot/

    #cp /pscratch/sd/n/nanr/v21.LR.BSMYLE_v2/v21.LR.BSMYLE_v2.2014-02.001/case_scripts.001/user_nl_eam .
