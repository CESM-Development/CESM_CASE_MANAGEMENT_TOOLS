...
## Using V8 datm files
## cp -fp ${TOOLS}/user_nl_files/I20TRELM_CRUNCEP.V8/user_datm.* ${CASE_SCRIPTS_DIR}/

# Simulation
#COMPSET="I20TRELM"
COMPSET="20TR_DATM%CRU_ELM%SP_SICE_SOCN_MOSART_SGLC_SWAV_SIAC_SESP"
RESOLUTION="ne30pg2_EC30to60E2r2"
CASE_NAME="v21.LR.I20TRELM_CRUNCEP_V8"
CASE_GROUP="v21.LR"
...
if [ "${run}" != "production" ]; then
  ...
  WALLTIME="12:00:00"
  STOP_OPTION="nyears"
  STOP_N="50" # How often to stop the model, should be a multiple of REST_N
  REST_OPTION="ndays"
...
#cp -fp ${TOOLS}/user_nl_files/I20TRELM_CRUNCEP.V8/user_datm.* ${CASE_SCRIPTS_DIR}/
cp -fp ${TOOLS}/user_nl_files/I20TRELM_CRUNCEP_V8/user_datm.streams.txt.CLMCRUNCEP.Precip_v8 ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMCRUNCEP.Precip
cp -fp ${TOOLS}/user_nl_files/I20TRELM_CRUNCEP_V8/user_datm.streams.txt.CLMCRUNCEP.Solar_v8  ${CASE_SCRIPTS_DIR}/ user_datm.streams.txt.CLMCRUNCEP.Solar
cp -fp ${TOOLS}/user_nl_files/I20TRELM_CRUNCEP_V8/user_datm.streams.txt.CLMCRUNCEP.TPQW_v8   ${CASE_SCRIPTS_DIR}/user_datm.streams.txt.CLMCRUNCEP.TPQW
cp -fp ${TOOLS}/user_nl_files/I20TRELM_CRUNCEP_V8/user_datm.streams.txt.co2tseries.20tr   ${CASE_SCRIPTS_DIR}/
