...
CASE_NAME="v21.LR.BSMYLEsmbb-EAMI.${useyear}-${usemonth}.${mbr}"
if [[ ${imbr} -eq "1" ]]
then
  #MAIN_CASE_NAME="v21.LR.BSMYLE-MYTEST.${useyear}-${usemonth}.${mbr}"
  MAIN_CASE_NAME="v21.LR.BSMYLEsmbb-EAMI.${useyear}-${usemonth}.${mbr}"
fi
CASE_GROUP="v21.LR"
...
#OLD_EXECUTABLE=""
OLD_EXECUTABLE="/pscratch/sd/n/nanr/v21.LR.BSMYLE_v2/exeroot/build"
