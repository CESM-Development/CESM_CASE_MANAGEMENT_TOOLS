...
CASE_NAME="v21.LR.BSMYLEsmbb_v8.${useyear}-${usemonth}.${mbr}"
if [[ ${imbr} -eq "1" ]]
then
  #MAIN_CASE_NAME="v21.LR.BSMYLE-MYTEST.${useyear}-${usemonth}.${mbr}"
  MAIN_CASE_NAME="v21.LR.BSMYLEsmbb_v8.${useyear}-${usemonth}.${mbr}"
fi
CASE_GROUP="v21.LR"
...
GET_REFCASE=false
RUN_REFDIR="/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/e3sm_init/v21.LR.SMYLE_IC_V8.${useyear}-${usemonth}.01/"
RUN_REFCASE="v21.LR.SMYLE_IC_V8.${useyear}-${usemonth}.01"
...
case_setup() {
    ...
    eamic="v21.LR.SMYLE_IC_V8.${useyear}-${usemonth}.01.eam.i.${useyear}-${usemonth}-01-00000.nc"
    perteamic="v21.LR.SMYLE_IC_V8.pert.eam.i.${useyear}-${usemonth}-01-00000.nc"
    ics="/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/e3sm_init/v21.LR.SMYLE_IC_V8.${useyear}-${usemonth}.01/"
