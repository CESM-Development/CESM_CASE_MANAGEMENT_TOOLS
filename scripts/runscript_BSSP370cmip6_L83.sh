...
./xmlchange RUN_REFCASE='b.e21.BHISTcmip6.f09_g17.L83_cam6.001'
...
cp $curdir/user_nl_files/AMIP-ssp370/user_nl_cam-QBOi ./user_nl_cam
...
cp $curdir/user_nl_files/AMIP-ssp370/user_nl_ww .
