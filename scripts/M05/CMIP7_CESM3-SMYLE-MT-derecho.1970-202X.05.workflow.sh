...
for useyear in $(seq 1990 1990)
do
usemonth=05

#main_case_root='b.e30_'$usetag'.'$compset'.'$resoln'.'${useyear}'-'${usemonth}'.001'
main_case_root=b.e30_${cesmtag:(-8)}.${compset}_SMYLE_CMIP7_PE.${useresoln}.${useyear}-${usemonth}.001
...
runname=b.e30_${cesmtag:(-8)}.${compset}_SMYLE_CMIP7_PE.${useresoln}.${useyear}-${usemonth}.$mbr
