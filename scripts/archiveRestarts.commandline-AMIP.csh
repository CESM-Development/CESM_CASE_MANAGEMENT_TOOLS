...
foreach case ( f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6_nudging_clim_SSP370.001 f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6_nudging_clim_SSP370.002 f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6_nudging_clim_SSP370.003 )
  date
  cd ${disk}
  if ! ( -d ${arcd}/${case} ) then
    mkdir -p ${arcd}/${case}
