...
#setenv HOMEDIR `pwd`
setenv HOMEDIR /glade/u/home/nanr/ccp/decadalPrediction/decadalPrediction-ASD/
...
# ===========================================
# REMEMBER:  use full year for this script
...
set REFCASE    = b.e11.BDP_IC_BA${NEX}.f09_g16.${yearm1}-11.01	
set SHORTCASE  = b.e11.BDP_BA${NEX}.f09_g16.${yearm1}-11
if ($mbr < 10) then
	set CASE = b.e11.BDP_BA${NEX}.f09_g16.${yearm1}-11.00${mbr}
else
	set CASE = b.e11.BDP_BA${NEX}.f09_g16.${yearm1}-11.0${mbr}
endif
echo 'Year   = ' $year
echo 'Member = ' $mbr
echo 'BA Experiment = ' $NEX
echo 'Case   = ' $CASE
...
setenv DPDIR   /glade/scratch/nanr/DP/rundir/
