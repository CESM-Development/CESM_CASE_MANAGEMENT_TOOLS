...
setenv CASENAME b.e21.${USECOMPSET}.f09_g17.TIPMIP_0.3Sv.00${mbr}
...
cp $CESM_TOOLS/user_nl_files/0.3Sv/user_nl_pop $CASEROOT/user_nl_pop
cp $CESM_TOOLS/user_nl_files/0.3Sv/user_nl_clm $CASEROOT/user_nl_clm
cp $CESM_TOOLS/SourceMods/src.pop/* $CASEROOT/SourceMods/src.pop/

cp /glade/work/nanr/amoc-hosing/Hosing_LabradorSea_65W45W48N65N_0To03Svin200yr-xtime.nc /glade/derecho/scratch/nanr/$CASENAME/run/

#copy restarts
echo $SCRATCH/archive/$REFCASE/rest/$REFDATE-00000/
cp $SCRATCH/archive/$REFCASE/rest/$REFDATE-00000/* $SCRATCH/$CASENAME/run/
