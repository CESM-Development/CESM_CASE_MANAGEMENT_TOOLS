...
setenv HOMEDIR `pwd`
setenv HOMEDIR /global/u2/n/nanr/ccp/decadalPrediction-No_Volc/setup
setenv CESMROOT /project/projectdirs/ccsm1/collections/cesm1_1_2_LENS_n21/
...
setenv CESMINPUT /global/project/projectdirs/ccsm1/inputdata
setenv DPINPUT /global/project/projectdirs/ccp/inputdata/DP
...
set REFCASE    = b.e11.BDP_IC.f09_g16.${yearm1}-11.01	
if ($mbr < 10) then
	set CASE = b.e11.BDPNoVLC.f09_g16.${yearm1}-11.n21.10${mbr}
else
	set CASE = b.e11.BDPNoVLC.f09_g16.${yearm1}-11.n21.1${mbr}
endif
echo 'Year = ' $year
echo 'Member = ' $mbr
echo 'Case = ' $CASE

setenv CASEROOT /global/project/projectdirs/ccsm1/runs/cesm1_1/decadalPrediction/$CASE
setenv WKDIR   /global/cscratch1/sd/nanr/DP
setenv RESTDIR /$WKDIR/inputdata/ccsm4_init/$REFCASE/$yearm1-11-01/
...
./xmlchange -file env_run.xml   -id DOUT_S_ROOT     -val '/global/cscratch1/sd/$CCSMUSER/DP/archive/$CASE/'
./xmlchange -file env_build.xml -id EXEROOT         -val '/global/cscratch1/sd/$CCSMUSER/DP/$CASE/bld'
./xmlchange -file env_run.xml   -id RUNDIR          -val '/global/cscratch1/sd/$CCSMUSER/DP/$CASE/run'
...
./cesm_setup
 ...
 cp ~/NoVolc/l_archive.template-1955-11 ./$CASE.l_archive
