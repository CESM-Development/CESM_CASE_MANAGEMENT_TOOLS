...
#restart
mkdir /glade/scratch/nanr/$casename/
mkdir /glade/scratch/nanr/$casename/run
cd  /glade/scratch/nanr/$casename/run
cp /glade/scratch/nanr/archive/CAM5.ctrl-{$member}/rest/*/* .
...
if ( $member == 01 ) then
  ...
  ln  -s /glade/scratch/nanr/PMay0-01/bld/cesm.exe  .
endif

cd $caseroot

# copy namelist
cp ${tools}/namelist/nanRerun/user_nl_clm_P0  ${caseroot}/user_nl_clm 
