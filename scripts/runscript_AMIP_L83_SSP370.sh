...
compset='FHIST_BGC'
resoln='f09_f09_mg17'
runname='f.e21.'$compset'.'$resoln'.L83_cam6_SSP370.'$mbr
...
./xmlchange RUN_REFCASE=f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6.${mbr}
...
cp $curdir/user_nl_files/AMIP-ssp370/user_nl_cam .
cp $curdir/user_nl_files/AMIP-ssp370/user_nl_clm .
cp $curdir/user_nl_files/AMIP-ssp370/user_nl_cpl .
cp $curdir/user_nl_files/AMIP-ssp370/user_nl_cice .
cp $curdir/user_nl_files/AMIP-ssp370/user_nl_mosart .
...
ncdata         = 'f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6.${mbr}.cam.i.2015-01-01-00000.nc'
...
echo "/glade/scratch/nanr/archive/f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6.${mbr}/rest/2015-01-01-00000/rpointer* $rundir"
cp /glade/scratch/nanr/archive/f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6.${mbr}/rest/2015-01-01-00000/rpointer* $rundir
ln -s /glade/scratch/nanr/archive/f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6.${mbr}/rest/2015-01-01-00000/f* $rundir/

#if [$mbr != '001']
#then
#./xmlchange EXEROOT='/glade/scratch/nanr/f.e21.FHIST_BGC.f09_f09_mg17.L83_cam6_SSP370.001/bld/'
