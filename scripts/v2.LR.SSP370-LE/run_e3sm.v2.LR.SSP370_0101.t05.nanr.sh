...
# Simulation
readonly COMPSET="WCYCLSSP370"
readonly RESOLUTION="ne30pg2_EC30to60E2r2"
readonly CASE_NAME="v2.LR.SSP370_0101.t01"
readonly CASE_GROUP="v2.LR"

# Code and compilation
readonly CHECKOUT="20211103"
...
readonly START_DATE="2015-01-01"    # for SSP370 this is set automatically via the compset config

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=TRUE
readonly RUN_REFDIR="/global/cscratch1/sd/jjbenedi/ssp370/rest_for_hybrid/v2.LR.historical_0101/init/2015-01-01-00000"
...
# Set paths
#readonly CODE_ROOT="${HOME}/cori/model/E3SMv2_master_ssp370_${CHECKOUT}"
#readonly CODE_ROOT="/global/homes/j/jjbenedi/cori/model/E3SMv2_master_ssp370_${CHECKOUT}"
readonly CODE_ROOT="/global/project/projectdirs/ccsm1/people/nanr/e3sm_tags/E3SMv2/sandbox-SSP/E3SM"
#readonly CODE_ROOT="/global/project/projectdirs/ccsm1/people/nanr/e3sm_tags/E3SMv2/E3SM"
#readonly CASE_ROOT="${CODE_ROOT}/cases/${CASE_NAME}"
#readonly CODE_ROOT="${HOME}/E3SMv2/code/${CHECKOUT}"
#readonly CASE_ROOT="/global/cscratch1/sd/${USER}/E3SMv2/${CASE_NAME}"
readonly CASE_ROOT="/global/project/projectdirs/ccsm1/people/nanr/cases/e3smv2/${CASE_NAME}"

# Sub-directories
#readonly CASE_BUILD_DIR=/global/cscratch1/sd/${USER}/e3sm_scratch/cori-knl/${CASE_NAME}/bld
#readonly CASE_ARCHIVE_DIR=/global/cscratch1/sd/${USER}/e3sm_scratch/cori-knl/${CASE_NAME}/archive
#readonly CASE_BUILD_DIR=${CASE_ROOT}/build
#readonly CASE_ARCHIVE_DIR=${CASE_ROOT}/archive
readonly CASE_BUILD_DIR=/global/cscratch1/sd/nanr/${CASE_NAME}/bld
readonly CASE_ARCHIVE_DIR=/global/cscratch1/sd/nanr/archive/${CASE_NAME}
