...
# It would be good to run each of them to the end of Feb of the following year.  So for Aug that would be 7 months,  May would be 10 months and Feb would be 13 months
./xmlchange STOP_N=16
./xmlchange REST_N=16
