...
setenv CESM2_TOOLS_ROOT /glade/work/nanr/cesm_tags/CASE_tools/cesm2-subCESMulator/pp/
...
# ...
set CASE = b.e21.BHISTcmip6.f09_g17.subCESMulator.001
#set CASE = b.e21.BSSP370cmip6.f09_g17.subCESMulator.001
...
pp_config --set TIMESERIES_OUTPUT_ROOTDIR=/glade/campaign/cgd/ccr/nanr/AMOC/LR/timeseries/$CASE
...
sed -i "s/tPP/t.subCAM/g" $CASEROOT/$CASE/postprocess/timeseries
qsub timeseries
