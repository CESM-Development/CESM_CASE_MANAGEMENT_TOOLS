...
set atmcaseRCP  =  b.e11.BRCP85C5CNBDRD.f09_g16.034
if ($yearm1 >= 2006) then
...
set atmdir = /glade/scratch/adrianne/archive/${atmcase}/atm/init/
set lnddir = /glade/scratch/adrianne/archive/${atmcase}/lnd/rest/
set rtmdir = /glade/scratch/adrianne/archive/${atmcase}/rof/rest/
