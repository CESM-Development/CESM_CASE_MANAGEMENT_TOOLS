...
## me
    ...
    old_rvals_file = os.path.join("/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/e3sm_init","v21.LR.SMYLE_IC."+date[0:7]+".01","eamic_"+date+".{}-{}.txt-old".format(ensemble_start,ensemble_end))
...
def create_eam_ic_perturbed(original, ensemble_start,ensemble_end, date, baserundir, model, outroot="v21.LR.SMYLE_IC.pert.eam.i.", factor=0.15):
    ...
    pertroot = os.path.join("/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/e3sm_init","v21.LR.SMYLE_IC."+date[0:7]+".01","pert.01")
...
def _main_func(description):
    ...
    sdrestdir = os.path.join("/global/cfs/cdirs/mp9/E3SMv2.1-SMYLE/inputdata/e3sm_init","v21.LR.SMYLE_IC."+date[0:7]+".01","{}".format(date))
    user = os.getenv("USER")
    baserundir = os.path.join("/pscratch/sd/n/{}/".format(user),"v21.SMYLE","v21.LR.BSMYLE."+date[0:7]+".001","run.{:03d}".format(ensemble_start))
    eaminame = os.path.join(sdrestdir,"v21.LR.SMYLE_IC.{}.01.eam.i.{date}-00000.nc".format(date[:7],date=date))
    outroot = "v21.LR.SMYLE_IC.pert.eam.i."
