...
for year in {1959..2019}; do
  case=v21.LR.SMYLE_IC_TRENDY.${year}-02.01
  poprfout=v21.LR.SMYLE_IC_TRENDY.${year}-02.01.mpaso.rst.$year-02-01_00000.nc
  icerfout=v21.LR.SMYLE_IC_TRENDY.${year}-02.01.mpassi.rst.$year-02-01_00000.nc
