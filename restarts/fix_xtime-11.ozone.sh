...
for year in {2018..2018}; do
  case=v21.LR.SMYLE_IC_ozone.${year}-11.01
  poprfout=v21.LR.SMYLE_IC_ozone.${year}-11.01.mpaso.rst.$year-11-01_00000.nc
  icerfout=v21.LR.SMYLE_IC_ozone.${year}-11.01.mpassi.rst.$year-11-01_00000.nc
