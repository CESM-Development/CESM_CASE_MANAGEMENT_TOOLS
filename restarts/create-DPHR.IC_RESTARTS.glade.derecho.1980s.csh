...
set mach = derecho
	set SCRATCH = /glade/derecho/scratch/nanr/
        set atmdir  = /glade/campaign/cesm/development/espwg/JRA55_regridded_to_CAM/ne120_L30/
	#set ocnpath = /glade/campaign/cgd/oce/projects/FOSI/HR/
	set ocnpath = /glade/derecho/scratch/fredc/archive/
        set lndpath = /glade/derecho/scratch/fredc/archive/
	set lndcase =  f.e13.FAMIPC5.ne120_ne120_mt12.rerun-gen-restarts.001

set syr = 1985
set eyr = 1985
set lndpath = /glade/campaign/collections/cmip/CMIP6/CESM-HR/inputdata/AMIP-land-IC/rest
...
set Picdir = ${SCRATCH}/inputdata/HR-DP/cesm2_init/{$case}/
set icdir  = ${SCRATCH}/inputdata/HR-DP/cesm2_init/{$case}/${year}-${mon}-01
if (! -d ${Picdir}) then
 mkdir ${Picdir}
endif
if (! -d ${icdir}) then
...
set lnddir = ${lndpath}/${year}-${mon}-01-00000/
...
#set icefout = ${case}.cice4.r.tx01v2.${year}-${mon}-01-00000.nc
...
set poprofname = ${ocncase}.pop.ro.tx01v2.0${ocnyr}-${mon}-01-00000    
set poprhfname = ${ocncase}.pop.rh.ecosys.nyear1.tx01v2.0${ocnyr}-${mon}-01-00000.nc 

#/glade/derecho/scratch/fredc/archive/g.e21.GIAF.TL319_t13.5thCyc.ice.001/rest/0305-05-01-00000/g.e21.GIAF.TL319_t13.5thCyc.ice.001.pop.r.tx01v2.0305-05-01-00000.nc
...
#echo "$case.cice.r.tx01v2.$year-${mon}-01-00000.nc"  > ${icdir}/rpointer.ice
