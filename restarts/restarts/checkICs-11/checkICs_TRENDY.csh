...
foreach mbr  ( `seq 2 20` )
    ...
    set file = v21.LR.SMYLE_IC_TRENDY.pert.eam.i.${year}-${mon}-01-00000.nc

    echo "checking year $year-$mon-$mbr_padZeros" >> ${year}-${mon}_TRENDY.ics
    ncdump -h $dirpath/$case/pert.$mbr_padZeros/$file | grep ncdiff >> ${year}-${mon}_TRENDY.ics
