...
set mach = derecho
if ($mach == "derecho") then
	set SCRATCH = /glade/derecho/scratch/nanr/
	#set SCRATCH = /glade/campaign/collections/cmip/CMIP6/CESM-HR/
	## Steve Yeager:
	...
	#set lndpath = /glade/derecho/scratch/nanr/archive/
...
#set eyr = 1970
# Nan added Caspian
#set ocnpath = /glade/derecho/scratch/nanr/archive/
set ocnpath = /glade/derecho/scratch/fredc/archive/
set atmdir  = /glade/derecho/scratch/nanr/analyses_output_ne120/
#else
set syr = 2023
set eyr = 2023
...
set ocndir = ${ocnpath}/g.e21.GIAF.TL319_t13.5thCyc.ice.001/rest/0${ocnyr}-${mon}-01-00000/
#g.e21.GIAF.TL319_t13.5thCyc.ice.001/rest/0310-11-01-00000
