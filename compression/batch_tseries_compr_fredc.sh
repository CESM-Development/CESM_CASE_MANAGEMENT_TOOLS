...
sed -i -e 's/SBATCH\s-J\stranspose/SBATCH -J ts1/g' $DEST_PREFIX/$CASE/tseries.slurm
...
sed -i -e 's/SBATCH\s-J\stranspose2/SBATCH -J ts2/g' $DEST_PREFIX/$CASE/tseries2.slurm

#start_YR=2086
#end_YR=2102

cp /work/06921/agopal/frontera/transpose/jobPub3.sh $DEST_PREFIX/$CASE/tseries3.slurm
sed -i -e 's/SBATCH\s-J\stranspose3/SBATCH -J ts3/g' $DEST_PREFIX/$CASE/tseries3.slurm
