...
set case = b.e21.DP-HR_IC.f09_g16.${year}-${mon}.01
set Picdir = /scratch1/06091/nanr/DP-HR/inputdata/cesm2_init/{$case}/
set icdir  = /scratch1/06091/nanr/DP-HR/inputdata/cesm2_init/{$case}/${year}-${mon}-01
if (! -d ${Picdir}) then
 mkdir ${Picdir}
endif
if (! -d ${icdir}) then
...
set lnddir = /scratch1/02503/edwardsj/archive/f.e13.FAMIPC5.ne120_ne120_mt12.cesm-ihesp-hires1.0.32_gen-restarts.0097/rest/1960-11-01-00000/
...
@ ocnyr   = $year - $offset
set ocndir = /scratch1/06090/fredc/g.e21.GIAF.TL319_t13.5thCyc.ice.001/rest/0${ocnyr}-${mon}-01-00000/
